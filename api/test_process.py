...
def get_user_question(level: str) -> Questions.json:
    ...
    if questions:
        ...
        for question in questions:
            generate_questions = {'question_text': question.main_question,
                                  'variants': [question.answer_1,
                                               question.answer_2,
                                               question.answer_3,
                                               question.answer_4]}
            result.append({'question_id': question.id, 'question': generate_questions})
